                        ...
                        <tr class="cart_table_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="product/<?php echo $product['id'] . '-' . slug($product['name']); ?>">
                                    <img width="145" height="145" alt="" class="img-responsive" src="<?php echo 'public/upload/products/' . $product['image'] ?>">
                                </a>
                            </td>
                            ...
                            <td class="product-quantity">
                                <div class="quantity">
                                    <input type="number" title="Nhập Để Đổi Số Lượng" value="<?php echo $product['number']; ?>" name="number[<?php echo $product['id']; ?>]" min="1" max="100">
                                </div>
                            </td>
                    ...
                    <tr>
                        <td class="actions" colspan="6">
                            <div class="actions-continue">
                                <input type="submit" value="Cập Nhật Giỏ Hàng" class="btn btn-default btn btn-primary" title='Cập nhật nếu bạn có thay đổi số lượng'>
                            </div>
                        </td>
                    </tr>
                </tbody>
